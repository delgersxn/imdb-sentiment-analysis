from sklearn.metrics import classification_report # Imports function to print classification metrics
import joblib                                    # Imports joblib for loading saved models

def evaluate_model(X_texts, y_true):             # Defines a function to evaluate the model (review, sentiment)
    ...
    print(classification_report(y_true, y_pred)) # Prints precision, recall, f1-score, and support
